...
## 1. Active Theme & Dependency

* **Active Theme**: Junkfeathers Machine (Child Theme)
* **Parent Theme Dependency**: GeneratePress (Installed Parent Theme)
...
1. **[style.css](wp-content/themes/junkfeathers-machine/style.css)**
...
2. **[functions.php](wp-content/themes/junkfeathers-machine/functions.php)**
...
3. **[README.md](wp-content/themes/junkfeathers-machine/README.md)**
   - **Purpose**: Developer installation documentation.
...
To preserve clean code and keep a maintainable site structure, custom logic should be segregated:
