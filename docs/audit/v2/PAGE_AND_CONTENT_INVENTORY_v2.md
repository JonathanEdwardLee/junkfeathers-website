# Page & Content Inventory (v2)

This document maps the layout and contents of all pages, menus, custom post types, and media assets currently present on the junkfeathers.com local environment running under WordPress 7.0.1.
